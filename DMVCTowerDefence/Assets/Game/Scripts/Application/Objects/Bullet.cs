...
public abstract class Bullet : ReusbleObject, IReusable
{
    ...
    public void Load(int bulletID, int level, Rect mapRect)
    {
        ...
        BulletInfo info = LBGameWorld._lbGameWorldLogicCtrl.StaticData.GetBulletInfo(bulletID);
    ...
    IEnumerator DestoryCoroutine()
    {
        ...
        //回收
        LBGameWorld._lbGameWorldLogicCtrl.ObjectPool.Unspawn(this.gameObject);
    }
